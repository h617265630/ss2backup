    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">Book</strong> / <small><a href="{{url('/book/highRatingBook')}}">High Rating Book List</a></small></div>
            </div>
                ...
                <div class="am-u-sm-12">
                    <form class="am-form">
                        <table class="am-table am-table-striped am-table-hover table-main">
                            <thead>
                            <tr>
                                </th><th class="table-id">ID</th > <th class="table-id">Avg Rating</th ><th class="table-id">Profile</th><th class="table-title">Title<th class="table-type">Genre</th><th class="table-author am-hide-sm-only">Author</th><th class="table-date am-hide-sm-only">published_year</th>
