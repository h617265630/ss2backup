    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">Review</strong> / <small>Add Review</small></div>
            </div>

            <form class="am-form am-form-horizontal" method="post" action="{{url('/review/addReview')}}">
                <div class="am-g">
                    ...
                    <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                ...
                                <textarea class="form-control" id="deblock_udid" name="content" rows="16" } style="min-width: 90%"></textarea>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" id="Author" placeholder="rating" name="rating">
